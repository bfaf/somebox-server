...
public class KeycloakRoleConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        // Extract realm_access roles and map them to GrantedAuthority object
    ...
    public static List<GrantedAuthority> extractRealmAccessRoles(Jwt jwt) {
        ...
        return roles.stream().map(roleName -> new SimpleGrantedAuthority("ROLE_" + roleName.toUpperCase())).collect(Collectors.toList());
    }
}
